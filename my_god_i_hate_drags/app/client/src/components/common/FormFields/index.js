...
const FormField = Component => {
  const RenderField = ({input, meta, children, hasInlineLabel = true, hasFeedback, label, hasRequiredIndicator = false, ...rest}) => {
...
export const ADatePicker = FormField(DatePicker)
export const ARangePicker = FormField(RangePicker)
